...
- 設計の正本は `doc/00-overview.md`〜`doc/04-ci-azure-pipelines.md` と `doc/issues/`。`doc/99-full-conversation-summary.md` は歴史的スナップショット、`doc/relaypublisher-design-and-copilot-issues.md` はポインタなので、どちらも実内容を編集しない。
