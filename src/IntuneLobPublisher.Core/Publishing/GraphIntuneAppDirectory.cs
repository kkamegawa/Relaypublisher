...
/// relative to its base address (Graph beta). <c>macOSPkgApp</c> is beta-only
/// (https://learn.microsoft.com/graph/api/resources/intune-apps-macospkgapp), so a v1.0 listing would
