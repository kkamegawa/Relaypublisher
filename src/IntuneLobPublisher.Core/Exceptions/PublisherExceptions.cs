...
/// <c>macOSMinimumOperatingSystem</c> flag.
/// </summary>
public sealed class UnsupportedMacOsVersionException : PublisherException
{
    public UnsupportedMacOsVersionException(string minimumOsVersion)
        : base($"MinimumOSVersion '{minimumOsVersion}' has no known macOS minimum-operating-system mapping.")
    {
        MinimumOsVersion = minimumOsVersion;
    }
